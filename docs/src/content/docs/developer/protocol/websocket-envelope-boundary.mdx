...
The production dispatcher binds valid `list` operations to live registry reads and bounded `roster` responses. Tickets #14–#24 connect delivery outcomes through the same strict parser, including the separate recoverable 256 KiB serialized-body denial. The generic 512 KiB frame boundary remains independent.
</Aside>
