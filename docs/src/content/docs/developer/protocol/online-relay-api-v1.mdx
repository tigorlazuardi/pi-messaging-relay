...
Ticket #36 implements cursor validation, model-tool schema, and bounded transport only. Production registry reads, page construction, `roster` responses, and model-tool WebSocket operations remain explicitly deferred to ticket #13.
</Aside>
