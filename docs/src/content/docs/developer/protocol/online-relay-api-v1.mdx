...
Sender-disconnect assertions (#21), retry and idempotence (#22), dedupe behavior (#23), the distinct 256 KiB body rule (#24), 128-send pipelining (#25), automatic reconnect (#26), restart authentication (#27), broader restart/reconnect replay assertions (#28), and additional diagnostics (#29) remain deferred. Ticket #20 adds no retry, automatic reconnect, persistence, or replay mechanism. This version publishes no I/O shape or runtime guarantee for those seams.
