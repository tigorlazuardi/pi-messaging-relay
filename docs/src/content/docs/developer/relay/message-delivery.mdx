...
Bounded automatic reconnect (#26) restores authenticated live presence, including authorization from the allowlist after a normal server restart (#27). Broader restart/reconnect no-replay assertions (#28) and additional diagnostics (#29) remain deferred. Restart persistence adds no message persistence, offline inbox, replay mechanism, or new reconnect event vocabulary.
</Aside>
