...
Bounded automatic reconnect (#26) now restores only authenticated live presence. Server-restart authentication (#27), broader restart/reconnect no-replay assertions (#28), and additional diagnostics (#29) remain deferred. Reconnect adds no message persistence, offline inbox, replay mechanism, or new reconnect event vocabulary.
</Aside>
